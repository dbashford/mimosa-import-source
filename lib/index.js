"use strict";
var config, fs, isBuild, logger, path, registration, watch, wrench, _, __checkForEdit, __cleanDirectories, __cleanFiles, __copy, __delete, __do, __importSource, __isExcluded, __makeFromPath, __makeToPath, __protectDestination, __startCopy, _cleanDirectories, _cleanFiles, _importSource;
...
__startCopy = function(copyConfig, howManyFiles, cb) {
  ...
  watcher = watch.watch(copyConfig.from, {
    ignored: ignored,
    persistent: !isBuild
  });
